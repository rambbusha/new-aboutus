    ...
    },
    {
        ...
        */
        var map = new google.maps.Map(document.getElementById('map_member'), {
            zoom: 2,
        ...
        */
        downloadUrl('maps/staffdb2xml.php', function (data) {
        ...
        */
        downloadUrl('sponsorsdb2xml.php', function (data) {
            var xml = data.responseXML;
            var markers = xml.documentElement.getElementsByTagName('marker');
            var markers_array = [];
            Array.prototype.forEach.call(markers, function (markerElem) {
